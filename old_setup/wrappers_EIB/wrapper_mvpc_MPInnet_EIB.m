function wrapper_mvpc_MPInnet_EIB
...
%Cfg_mvpcRoi.interactionModels(4).functionHandle = 'mvpc_neuralNet';
Cfg_mvpcRoi.interactionModels(4).functionHandle = 'sbatch_genScripts_nnet';
Cfg_mvpcRoi.interactionModels(4).parameters.nNodes = 10;
Cfg_mvpcRoi.interactionModels(4).parameters.functionHandle = 'mvpc_neuralNet_byComponent_indepPCA';
Cfg_mvpcRoi.interactionModels(4).parameters.savePath = Cfg_mvpcRoi.outputPaths.results;
Cfg_mvpcRoi.interactionModels(4).parameters.libraryPaths.mvpc = Cfg_mvpcRoi.libraryPaths.mvpc;
Cfg_mvpcRoi.interactionModels(4).parameters.libraryPaths.spm12 = Cfg_mvpcRoi.libraryPaths.spm12;
Cfg_mvpcRoi.interactionModels(4).parameters.slurm.nodes = 3;
Cfg_mvpcRoi.interactionModels(4).parameters.slurm.cpus_per_task = 1;
Cfg_mvpcRoi.interactionModels(4).parameters.slurm.task_per_node = 30;
Cfg_mvpcRoi.interactionModels(4).parameters.slurm.mem_per_cpu = 6000;
Cfg_mvpcRoi.interactionModels(4).parameters.slurm.email = 'daeda@mit.edu';
Cfg_mvpcRoi.interactionModels(4).parameters.slurm.name = 'MVPC_NNET';
