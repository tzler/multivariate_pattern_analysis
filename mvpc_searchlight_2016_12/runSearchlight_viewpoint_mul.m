function runSearchlight_viewpoint_mul(iSubject)
...
Cfg_searchlight.outputPath = '/mindhive/saxelab3/anzellotti/facesViewpoint/searchlight_results_mul';
...
Cfg_searchlight.regionModels(4).seed.label = sprintf('PCA_noLowPass_%02ddim',iDim);
