...
#SBATCH --output=../sbatch_mvpc_sl_rev_stdout_1.txt
#SBATCH --error=../sbatch_mvpc_sl_rev_stderr_1.txt
...
chmod +x sbatch_newMvpc_single_searchlight_rev_1.sh
mpiexec -n 4 ./sbatch_newMvpc_single_searchlight_rev_1.sh