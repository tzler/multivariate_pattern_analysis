...
#SBATCH --output=../sbatch_mvpc_sl_rev_stdout_2.txt
#SBATCH --error=../sbatch_mvpc_sl_rev_stderr_2.txt
...
chmod +x sbatch_newMvpc_single_searchlight_rev_2.sh
mpiexec -n 4 ./sbatch_newMvpc_single_searchlight_rev_2.sh