...
#SBATCH --output=../sbatch_newMvpc_sl_facesView_mul_stdout_1.txt
#SBATCH --error=../sbatch_newMvpc_sl_facesView_mul_stderr_1.txt
...
chmod +x sbatch_newMvpc_single_searchlight_mul_1.sh
mpiexec -n 4 ./sbatch_newMvpc_single_searchlight_mul_1.sh