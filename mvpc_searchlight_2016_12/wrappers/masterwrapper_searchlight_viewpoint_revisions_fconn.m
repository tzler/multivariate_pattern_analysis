...
mvpcDir = '/mindhive/saxelab3/anzellotti/facesViewpoint/MVPC_scripts_revision/mvpc_searchlight_2016_12/';
 ...
 parameters.slurm.name = 'mvpc_sl_revfconn';
...
newMvpc_scriptGenerator_searchlight_rev_fconn(nSubjects,scriptDir,mvpcDir,parameters);
 
 %% Submit to queue
 
system('cd /mindhive/saxelab3/anzellotti/facesViewpoint/MVPC_scripts_revision/mvpc_searchlight_2016_12/wrappers');
 for iJob = 1:3
 system(sprintf('sbatch sbatch_newMvpc_parallel_searchlight_rev_fconn_%d.sh',iJob));
 end
