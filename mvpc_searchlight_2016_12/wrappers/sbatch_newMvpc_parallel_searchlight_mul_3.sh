...
#SBATCH --output=../sbatch_newMvpc_sl_facesView_mul_stdout_3.txt
#SBATCH --error=../sbatch_newMvpc_sl_facesView_mul_stderr_3.txt
...
chmod +x sbatch_newMvpc_single_searchlight_mul_3.sh
mpiexec -n 2 ./sbatch_newMvpc_single_searchlight_mul_3.sh