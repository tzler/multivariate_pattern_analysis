...
#SBATCH --output=../sbatch_newMvpc_sl_facesView_uni_stdout_2.txt
#SBATCH --error=../sbatch_newMvpc_sl_facesView_uni_stderr_2.txt
...
chmod +x sbatch_newMvpc_single_searchlight_uni_2.sh
mpiexec -n 4 ./sbatch_newMvpc_single_searchlight_uni_2.sh