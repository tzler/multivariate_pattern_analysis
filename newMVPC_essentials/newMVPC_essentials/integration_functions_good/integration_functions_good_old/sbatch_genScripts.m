...
for iSubject = 1:length(subjects)
    ...
    fprintf(fid,'cd /mindhive/saxelab3/anzellotti/facesVoices_art2/newMVPC_essentials/integration_functions_good/integration_functions_good\n');
    fprintf(fid,'mvpc_multiRegionIntegration(%d);\n',iSubject);
    fclose(fid);
end
