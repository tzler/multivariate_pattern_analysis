...
#SBATCH --output=../sbatch_newMvpc_inter_facesVoices_stdout_45.txt
#SBATCH --error=../sbatch_newMvpc_inter_facesVoices_stderr_45.txt
...
chmod +x sbatch_newMvpc_single_interactions_45.sh
mpiexec -n 5 ./sbatch_newMvpc_single_interactions_45.sh