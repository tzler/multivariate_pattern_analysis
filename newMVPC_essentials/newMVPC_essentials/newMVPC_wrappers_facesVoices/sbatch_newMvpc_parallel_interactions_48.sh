...
#SBATCH --output=../sbatch_newMvpc_inter_facesVoices_stdout_48.txt
#SBATCH --error=../sbatch_newMvpc_inter_facesVoices_stderr_48.txt
...
chmod +x sbatch_newMvpc_single_interactions_48.sh
mpiexec -n 5 ./sbatch_newMvpc_single_interactions_48.sh