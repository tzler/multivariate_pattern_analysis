...
#SBATCH --output=../sbatch_newMvpc_inter_facesVoices_stdout_49.txt
#SBATCH --error=../sbatch_newMvpc_inter_facesVoices_stderr_49.txt
...
chmod +x sbatch_newMvpc_single_interactions_49.sh
mpiexec -n 5 ./sbatch_newMvpc_single_interactions_49.sh