...
load(sprintf(interactionModel.parameters.labelsTemplatePath,subject.ID));
results = feval(interactionModel.functionHandle,interactionModel.parameters,regionModel.preprocdata,labels);
