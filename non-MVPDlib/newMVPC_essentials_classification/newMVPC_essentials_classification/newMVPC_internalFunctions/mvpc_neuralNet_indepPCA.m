function results = mvpc_neuralNet_indepPCA(parameters,data)

nRois = length(data);
for iRoi = 1:nRois
    for jRoi = 1:nRois
        [~, meanVarexpl_byComp{iRoi,jRoi},~,weights{iRoi,jRoi}] = mvpc_neuralNet_byComponent_indepPCA(parameters,data{jRoi},data{iRoi});
