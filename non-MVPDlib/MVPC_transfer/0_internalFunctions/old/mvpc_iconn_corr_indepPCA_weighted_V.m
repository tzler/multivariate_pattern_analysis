function [r, varexpl] = mvpc_iconn_corr_indepPCA_weighted_V(seedData_reduced,sphereData_reduced)
...
%     residual = seedData_test' - predicted;
   ...
   varexpl(iRun) = ledoitWolf_varexpl(seedData_reduced{iRun}.test_voxelSpace',predicted*seedData_reduced{iRun}.V');
end
