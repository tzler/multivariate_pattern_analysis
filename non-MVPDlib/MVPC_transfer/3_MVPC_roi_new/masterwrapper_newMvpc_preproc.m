...
Cfg_mvpcRoi.libraryPaths.mvpc = '/mindhive/saxelab3/anzellotti/facesVoices_art2/mvpc3.0/';
...
Cfg_mvpcRoi.regionModels(2).steps(1).functionHandle = 'mvpc_mean_traintest';
% preprocessing without low pass filtering
Cfg_mvpcRoi.regionModels(3).label = 'PCA_noLowPass';
Cfg_mvpcRoi.regionModels(3).steps(1).functionHandle = 'mvpc_indepPCA_BIC';
Cfg_mvpcRoi.regionModels(3).steps(1).parameters.minPCs = 3;
Cfg_mvpcRoi.regionModels(3).steps(1).parameters.maxPCs = 20;
...
Cfg_mvpcRoi.interactionModels(1).functionHandle = 'mvpc_predict_y_equal_x';
Cfg_mvpcRoi.interactionModels(1).parameters.measureHandle{1} = 'accuracy_corr';
Cfg_mvpcRoi.interactionModels(1).parameters.measureHandle{2} = 'accuracy_rSquare';
...
Cfg_mvpcRoi.interactionModels(2).functionHandle = 'mvpc_predict_y_equal_x';
Cfg_mvpcRoi.interactionModels(2).parameters.measureHandle{1} = 'accuracy_corr';
Cfg_mvpcRoi.interactionModels(2).parameters.measureHandle{2} = 'accuracy_rSquare';
...
Cfg_mvpcRoi.interactionModels(3).functionHandle = 'mvpc_predict_lin';
Cfg_mvpcRoi.interactionModels(2).parameters.measureHandle{1} = 'accuracy_corr';
Cfg_mvpcRoi.interactionModels(2).parameters.measureHandle{2} = 'accuracy_rSquare';
Cfg_mvpcRoi.interactionModels(2).parameters.measureHandle{3} = 'accuracy_varexpl_vox_mean';
Cfg_mvpcRoi.interactionModels(2).parameters.measureHandle{4} = 'accuracy_varexpl_ledoitWolf';
