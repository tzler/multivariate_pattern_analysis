...
#SBATCH --output=../sbatch_newMvpc_inter_facesVoices_stdout_50.txt
#SBATCH --error=../sbatch_newMvpc_inter_facesVoices_stderr_50.txt
...
chmod +x sbatch_newMvpc_single_interactions_50.sh
mpiexec -n 5 ./sbatch_newMvpc_single_interactions_50.sh