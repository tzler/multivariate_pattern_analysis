...
#SBATCH --output=../sbatch_newMvpc_inter_facesVoices_stdout_47.txt
#SBATCH --error=../sbatch_newMvpc_inter_facesVoices_stderr_47.txt
...
chmod +x sbatch_newMvpc_single_interactions_47.sh
mpiexec -n 5 ./sbatch_newMvpc_single_interactions_47.sh