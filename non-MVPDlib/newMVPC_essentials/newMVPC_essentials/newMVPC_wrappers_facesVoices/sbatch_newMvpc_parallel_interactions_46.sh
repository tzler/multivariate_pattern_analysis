...
#SBATCH --output=../sbatch_newMvpc_inter_facesVoices_stdout_46.txt
#SBATCH --error=../sbatch_newMvpc_inter_facesVoices_stderr_46.txt
...
chmod +x sbatch_newMvpc_single_interactions_46.sh
mpiexec -n 5 ./sbatch_newMvpc_single_interactions_46.sh