...
Cfg_MVPDsearchlight.outputPaths.cfgPath = fullfile(Cfg_MVPDsearchlight.outputPaths.products,sprintf('Cfg_MVPDsearchlight_%s',iSubject));
...
% ######## Run ########
MVPDsearchlight_main(Cfg_MVPDsearchlight)
